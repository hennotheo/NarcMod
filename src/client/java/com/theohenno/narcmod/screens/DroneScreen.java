...
public class DroneScreen extends HandledScreen<ScreenHandler> {
    private static final Identifier TEXTURE = Identifier.ofVanilla("textures/gui/container/shulker_box.png");

    public DroneScreen(PlayerEntity player, DroneEntity drone) {
        super(new DroneScreenHandler(0, player.getInventory()), player.getInventory(), Text.translatable("container.crafting"));
    }
